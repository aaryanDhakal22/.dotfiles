...
from .views import student_list, notification_list, student_detail, transaction_detail

urlpatterns = [
    path("student/", student_list, name="student_list"),
    path("student/details/<str:studentId>", student_detail, name="student_detail"),
    path("notification/<str:studentunid>", notification_detial, name="notification_detail"),
