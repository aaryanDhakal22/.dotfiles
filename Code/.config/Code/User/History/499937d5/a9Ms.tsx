...
const NotificationEdit = ()=>{
    ...
    if(notsOfStudent.isSuccess){
        ...
        return(
            ...
            <button className="bg-background flex items-center p-3 rounded-3xl text-white" onClick={()=>navigate(-1)} ><IoArrowBackOutline style={{"display":"inline","fontSize":"50px"}}/> <span className="text-3xl">BACK</span> </button>
