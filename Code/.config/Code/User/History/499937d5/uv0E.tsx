    ...
    if(notsOfStudent.isSuccess){
        ...
        return(
            ...
            <div className="flex justify-between mt-10">
                ...
                <button className="btn  ml-16 flex items-center p-3 rounded-3xl text-white" onClick={()=>navigate(-1)} ><IoArrowBackOutline style={{"display":"inline","fontSize":"50px"}}/> <span className="text-3xl">BACK</span> </button>
