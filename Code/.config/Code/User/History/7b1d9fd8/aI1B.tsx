...
export const Navbar = ()=>{
    ...
    return (
        <div className="fixed top-0 left-0 h-screen w-50 flex flex-col items-center  bg-background px-5">
            <div className="w-46 ml-10">
                <img src={logo} alt="MitosysLogo" />
            </div>
            <div className="text-secondaryText px-5 py-3 rounded-lg w-48 text-center mt-20 border-secondaryText border-2 font-bold"> <MdAddCircleOutline style={{"display":"inline","fontSize":"25px"}} /> TRANSACTION</div>
