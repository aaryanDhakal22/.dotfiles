...
export const Navbar = ()=>{
    ...
    const unactiveClassName = "activated-border"
    return (
        <div className="fixed top-0 left-0 h-screen w-50 flex flex-col items-center  bg-background px-5">
            ...
            <div className="flex flex-col items-center text-primaryText text-2xl gap-10 mt-10">
                <NavLink to="/student" className={(isActive)=>{return isActive?activeClassName:}}>STUDENT</NavLink>
                <div className="disabled-border" >FEES</div>
                <div className="disabled-border" >C/D</div>
            </div>
        </div>
        // <>
