...
export const Navbar = ()=>{
    ...
    return (
        <div className="fixed top-0 left-0 h-screen w-50 flex flex-col  bg-background">
            ...
            <div className="text-secondaryText px-5 py-3 rounded-lg w- border-secondaryText border-2 font-bold"> <MdAddCircleOutline style={{"display":"inline","fontSize":"25px"}} /> TRANSACTION</div>
            <div className="">
                <div>STUDENT</div>
                <div>FEES</div>
                <div>C/D</div>
