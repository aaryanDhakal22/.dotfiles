...
<form onSubmit={formik.handleSubmit}>
    ...
    <button className="btn bg-dangerRed border-dangerRed active:text-dangerRed mt-10 ml-5" onClick={()=>deleteTransaction(notification.notificationId,()=>navigate(-1))}type="button">DELETE</button>
</form>
</div>
</div>
    )
