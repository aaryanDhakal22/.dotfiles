...
class NewTransactionTest(TestCase):
    ...
    def test_can_get_list_of_all_transaction(self):
        ...
        stored_first_obj = response[0]
        stored_second_obj = response[1]
        self.assertEqual(first_obj.name, stored_first_obj["payer"])
        self.assertEqual(second_obj.name, stored_second_obj["payer"])
        self.assertEqual(first_obj.age, stored_first_obj["amount"])
        self.assertEqual(second_obj.age, stored_second_obj["amount"])
