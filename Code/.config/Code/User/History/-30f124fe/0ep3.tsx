...
const CreditPage = ()=>{
    ...
    return (
        ...
        <FormControl sx={{ m: 1, minWidth: 120 }} size="medium">
            ...
            <Select id="type" name="type" defaultValue={"Donation"} value={type} label="Paid" onChange={handleChange}>     
        ...
        <FormControl sx={{ m: 1, minWidth: 120 }} size="medium">
            ...
            <Select id="subType" label="subTypeLabel" labelId="subTypeLabel" name="subType"  value={subType} onChange={formik.handleChange}>     
                {typeToSubType[type?type:"Donation"].map((item:string)=>{
