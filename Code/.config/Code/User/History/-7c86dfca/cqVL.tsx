    ...
    return (
        ...
        <form onSubmit={formik.handleSubmit}>
            ...
            <div className="formField">
                ...
                <input type="checkbox"  className="inputField bg-red-800" onChange={formik.handleChange} name="isAdmission" id="isAdmission" value={formik.values.isAdmission?"admission":undefined} checked={formik.values.isAdmission?true:false} />
            </div>
