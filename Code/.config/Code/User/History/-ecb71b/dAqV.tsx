...
const Tile =({profile}:{profile:Student})=>{
    ...
    return (
        <div className="bg-background p-10 rounded-2xl hover:scale-105 transition-all ease-linear hover:shadow-primaryText hover:shadow-lg " onClick={handleNavigate}>
