...
import FeeTile from "../../component/feetile/feetile.component";
...
const Student = ()=>{
    ...
    if(webState==="LOADING"){
        ...
        return (
            ...
            />
            <Routes>
                <Route path="/" element={<FeesCollection searchStd={searchstd} profiles = {profiles}/>} />
                <Route path="/fees/:unid" element= {<FeesDetails profiles={profiles} />}/>
            </Routes>
            </>
        )
    }
