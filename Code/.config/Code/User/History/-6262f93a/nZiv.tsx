...
export const PrintPage = () => {
    ...
    return (
        <div className="absolute bg-white aspect-[1/1.41] w-screen top-0 left-0 p-5 flex flex-col items-center">
            ...
            <div className="text-2xl mt-3 ml-10" >ANMOL SPECIAL EDUCATION CENTER</div>
            ...
            <div className="w-96 mt-5 text-2xl">
                <div className="table w-full border-2 border-black p-3">
                    <div className="table-header-group">
                        <div className="table-row ">
                            <div className="table-cell text-left p-2 border-b-2 border-black border-r-2">Header</div>
                            <div className="table-cell text-right p-2 border-b-2 border-black">Amount</div>
                        </div>
                    </div>
                    <div className="table-row-group">
                    <TableRowComp header={"monthly charge"} amount={notification.tuition} />
                    <TableRowComp header={"Therapy"} amount={notification.tuition} />
                    <TableRowComp header={"monthly charge"} amount={notification.therapy} />
                    <TableRowComp header={"monthly charge"} amount={notification.speechTherapy} />
                    <TableRowComp header={"monthly charge"} amount={notification.transportation} />
                    <TableRowComp header={"monthly charge"} amount={notification.snacks} />
                    <TableRowComp header={"monthly charge"} amount={notification.extras} />
...
const TableRowComp = ({header,amount}:{header:string,amount:number})=>{
    return (
        <div className="table-row  text-xl">
                    <div className="table-cell text-left border-b-2 border-gray-500 p-3 ">{header.toUpperCase() }</div>
                    <div className="table-cell text-right border-b-2 border-gray-500 p-3 ">Rs.{amount.toString()}</div>
         </div>
    )
}