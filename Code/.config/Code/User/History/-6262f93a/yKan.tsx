        ...
        <div className="absolute bg-white aspect-[1/1.41] w-screen top-0 left-0 p-5 flex flex-col items-center">
            ...
            <div className="w-96 mt-5 text-2xl">
                <table className=" w-full border-2 border-black p-3">
                    <thead className="">
                        <tr className="">
                            <th className=" text-left p-2 border-b-2 border-black border-r-2">Header</th>
                            <th className=" text-right p-2 border-b-2 border-black">Amount</th>
                        </tr>
                    </thead>
                    <tbody className=" " >
                        ...
                        <tr className=" text-xl">
                            <td className=" text-left border-b-2 border-gray-500 p-3 font-bold ">Grand Total</td>
                            <td className=" text-right border-b-2 border-gray-500 p-3 font-bold ">Rs.{notification.amount}</td>
                        </tr>
                    </tbody>
                </table>
...
const TableRowComp = ({header,amount}:{header:string,amount:number})=>{
    return (
        <tr className=" text-xl">
                    <td className=" text-left border-b-2 border-gray-500 p-3 ">{header.toUpperCase() }</td>
                    <td className=" text-right border-b-2 border-gray-500 p-3 ">Rs.{amount.toString()}</td>
         </tr>
    )
}