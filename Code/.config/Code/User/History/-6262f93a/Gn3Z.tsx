            ...
            <div className="w-96 mt-5 text-2xl">
                <div className="table w-full">
                    <div className="table-header-group">
                        ...
                        <div className="table-cell text-center ">Header</div>
...
const TableRowComp = ({header,amount}:{header:string,amount:number})=>{
    return (
        <div className="table-row">
                    <div className="table-cell text-center">{header.toUpperCase() }</div>
                    <div className="table-cell text-center">Rs.{amount.toString()}</div>
         </div>
    )
}