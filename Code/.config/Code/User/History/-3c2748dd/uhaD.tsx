...
const {data,isError,isLoading} = useStudentQuery()
const NotificationAdd = ()=>{
    ...
    const notification = {"studentId": studentId?studentId:"",'transactionId':newTransactionId,"notificationId":newNotificationId,...initialNotificationValues}
