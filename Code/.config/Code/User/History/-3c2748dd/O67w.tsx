...
const NotificationAdd = ()=>{
    ...
    const notification = {"studentId": studentId?studentId:"","notificationId":newNotificationId,...initialNotificationValues}
    ...
    return(
        ...
        <form onSubmit={formik.handleSubmit}>
            ...
            <Select id="paid" name="paid" defaultValue={"Unpaid"} value={formik.values.paid} label="Paid" onChange={formik.handleChange}>
