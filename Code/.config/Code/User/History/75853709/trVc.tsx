...
const NotificationEditForm = ({notification}:{notification:Notification})=>{
    ...
    return (
        ...
        <form onSubmit={formik.handleSubmit}>
            ...
            <FormField fieldFor={"date"} type={"text"} handleChange = {formik.handleChange} value ={formik.values.date}  />
            <FormField fieldFor={"month"} type={"text"} handleChange = {formik.handleChange} value ={formik.values.month}  />
            ...
            <button className="btn bg-dangerRed border-dangerRed active:text-dangerRed mt-10 ml-5"  data-bs-toggle="modal" data-bs-target="#deleteModal" type="button">DELETE</button>
