...
class ItemModelTest(TestCase):
    def test_saving_and_retrieving_items(self):
        first_item = Event()
        first_item.title = "the first ever event"
        ...
        second_item = Event()
        second_item.title = "the second event"
        ...
        self.assertEqual(first_saved_item.title, "the first ever event")
        self.assertEqual(first_saved_item.body, "the first ever event body")
        self.assertEqual(second_saved_item.title, "the second event")
...
class NewItemTest(TestCase):
    def test_can_save_a_POST_request(self):
        self.client.post(
            "/events/new",
            data={
                "title_text": "A new title for event",
        ...
        self.assertEqual(new_item.title, "A new title for event")
