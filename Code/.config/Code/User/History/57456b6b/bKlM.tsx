    ...
    return (
        <form className="" onSubmit={formik.handleSubmit}>
            <div className="flex  p-4">
                <label className="text-3xl text-primaryText self-center basis-1/4" htmlFor="name">NAME</label>
                <input className="text-3xl p-2 basis-3/4" id="name" name="name" type="text" onChange={formik.handleChange} value={formik.values.name}/>
            </div>
            <div className="">
