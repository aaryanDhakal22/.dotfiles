    ...
    return (
        <form className="" onSubmit={formik.handleSubmit}>
            <div className="flex justify-around p-4">
                <label className="text-3xl text-primaryText align-middle" htmlFor="name">NAME</label>
                <input className="text-3xl p-2" id="name" name="name" type="text" onChange={formik.handleChange} value={formik.values.name}/>
            </div>
            <div className="">
