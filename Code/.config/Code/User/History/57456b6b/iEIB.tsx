...
const PersonalForm = ({student,toAdd}:{student:Student,toAdd:boolean})=>{
    ...
    return (
        <form className="" onSubmit={formik.handleSubmit}>
            ...
            <FormField fieldFor={"age"} type={"text"} handleChange = {formik.handleChange} value ={formik.values.age}  />
            <FormField fieldFor={"phone"} type={"text"} handleChange = {formik.handleChange} value ={formik.values.phone}  />
