...
const StudentPage = ()=>{
    ...
    return (
        ...
        <div className=" flex justify-between items-center max-w-full bg-background h-24">
                <button className="btn" onClick={()=>navigate('/student/add')}><MdAddCircleOutline style={{"display":"inline","fontSize":"25px"}} />ADD</button>
                <button className="btn" > FILTER</button>
                <TextField className="justify-self-end" id="outlined-name"label="Search Student"value={searchstd}onChange={handleChange}/>
