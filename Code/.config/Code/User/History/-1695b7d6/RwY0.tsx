...
const StudentPage = ()=>{
    ...
    return (
        ...
        <div className=" flex flex-row gap-5 justify-end items-center max-w-full bg-background h-28">
                <button className="btn ml-12 " onClick={()=>navigate('/student/add')}><MdAddCircleOutline style={{"display":"inline","fontSize":"25px"}} />ADD</button>
                <button className="btn mr-auto ml-8" > FILTER</button>
                <input type="text" id="outlined-name" className="py-3 px-5 mr-32 text-2xl" value={searchstd}onChange={handleChange}/>
